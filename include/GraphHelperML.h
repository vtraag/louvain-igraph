...
class GraphML
{
  public:
    ...
    GraphML(igraph_t* graph,
      vector<double> const& edge_weights,
      vector<size_t> const& node_sizes);
    GraphML(igraph_t* graph, vector<double> const& edge_weights, int correct_self_loops);
    GraphML(igraph_t* graph, vector<double> const& edge_weights);
    GraphML(igraph_t* graph, vector<size_t> const& node_sizes, int correct_self_loops);
    GraphML(igraph_t* graph, vector<size_t> const& node_sizes);
    GraphML(igraph_t* graph, int correct_self_loops);
    GraphML(igraph_t* graph);
    GraphML();
    ~GraphML();
    ...
    GraphML* collapse_graph(MutableVertexPartition* partition);
